...
import KulturstienProject from '../views/projectViews/KulturstienProject.vue';
import AttractProject from '../views/projectViews/AttractProject.vue';
...
const routes = [
	...
	},
	{
		name: 'Kulturstien',
		path: '/kulturstien',
		component: KulturstienProject,
	},
	{
		name: 'Attract',
		path: '/attract',
		component: AttractProject,
	},
	{
		name: 'CdProject',
		path: '/cdproject',
